...
class CmsBundleBestSellerListingCmsElementResolver extends AbstractCmsElementResolver
{
    private const STATIC_SEARCH_KEY_MANUAL = 'best-seller-list-manual';
    ...
    {
        return 'cmsbundle-best-seller-list';
    }
