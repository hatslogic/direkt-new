...
Shopware.Service("cmsService").registerCmsBlock({
  ...
  component: "sw-cms-block-cmsbundle-recently-viewed-product-slider",
  previewComponent: "sw-cms-preview-cmsbundle-recently-viewed-product-slider",
  defaultConfig: {
    marginBottom: "20px",
    marginTop: "20px",
    marginLeft: "20px",
  ...
  slots: {
    ...
    product: {
      type: "cmsbundle-recently-viewed-product-slider",
      default: null,
    },
    button: {
