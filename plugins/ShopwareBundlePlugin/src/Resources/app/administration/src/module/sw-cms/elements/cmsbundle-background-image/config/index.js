import template from "./sw-cms-el-config-cmsbundle-background-image.html.twig";
import "./sw-cms-el-config-cmsbundle-background-image.scss";

const { Component, Mixin } = Shopware;

Component.register("sw-cms-el-config-cmsbundle-background-image", {
  template,
  ...
  computed: {
    ...
    uploadTagDesktop() {
      return `cms-element-cmsbundle-background-image-desktop-config-${this.element.id}`;
    },

    uploadTagTablet() {
      return `cms-element-cmsbundle-background-image-tablet-config-${this.element.id}`;
    },

    uploadTagMobile() {
      return `cms-element-cmsbundle-background-image-mobile-config-${this.element.id}`;
    },
    ...
    previewSourceMobile() {
      if (this.element?.dataMobile?.media?.id) {
