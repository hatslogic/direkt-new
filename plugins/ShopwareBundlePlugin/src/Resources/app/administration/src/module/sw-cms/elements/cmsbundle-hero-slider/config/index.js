import template from "./sw-cms-el-config-cmsbundle-hero-slider.html.twig";
import "./sw-cms-el-config-cmsbundle-hero-slider.scss";

const { Component, Mixin } = Shopware;

Component.register("sw-cms-el-config-cmsbundle-hero-slider", {
  template,
  ...
  methods: {
    ...
    onImageRemoveBackgroundTablet() {
      this.element.config.backgroundTablet.value = null;
