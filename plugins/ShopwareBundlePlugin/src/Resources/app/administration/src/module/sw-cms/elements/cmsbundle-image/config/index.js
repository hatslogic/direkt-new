import template from './sw-cms-el-config-cmsbundle-image.html.twig';
import './sw-cms-el-config-cmsbundle-image.scss';

const { Component, Mixin } = Shopware;

Component.register('sw-cms-el-config-cmsbundle-image', {
    template,
    ...
    methods: {
        ...
        async onImageUploadDesktop({ targetId }) {
            const mediaDesktopEntity = await this.mediaRepositoryDesktop.get(targetId);
