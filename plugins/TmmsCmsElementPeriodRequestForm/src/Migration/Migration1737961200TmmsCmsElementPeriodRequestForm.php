...
class Migration1737961200TmmsCmsElementPeriodRequestForm extends MigrationStep
{
    ...
    public function update(Connection $connection): void
    {
        $connection->executeStatement('
            CREATE TABLE IF NOT EXISTS `periodrequestform` (
                ...
                `freeinput5label` VARCHAR(255) NULL,
                `freeinput5` LONGTEXT NULL,
                `freeinput6label` VARCHAR(255) NULL,
                `freeinput6` LONGTEXT NULL,
                `freeinput7label` VARCHAR(255) NULL,
                `freeinput7` LONGTEXT NULL,
                `freeinput8label` VARCHAR(255) NULL,
                `freeinput8` LONGTEXT NULL,
                `freeinput9label` VARCHAR(255) NULL,
                `freeinput9` LONGTEXT NULL,
                `freeinput10label` VARCHAR(255) NULL,
                `freeinput10` LONGTEXT NULL,
        ...
        $connection->executeStatement('
            ...
            ADD answered TINYINT(1) NULL DEFAULT "0";');
    }
